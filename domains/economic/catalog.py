...
ECONOMIC_CAPABILITIES = (
    {
        ...
        "workflow_ids": ["economic_discovery"],
    ...
    },
    {
        ...
        "workflow_ids": ["economic_evidence"],
        "environments": ["memory", "local", "production"],
        "geometry": "none",
        "request_requirements": _analysis_requirements(),
...
_QUERY_SCHEMA = {
    ...
    "properties": {
        ...
        "geography_level": {"type": "string", "minLength": 1, "maxLength": 32},
