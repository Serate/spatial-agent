...
- Current work: M81.2 工具动态扩展进行中——ToolRegistry.register_tool（受控注册 + handler 回退分发 + schema 校验）+ 演示 estimate_area + GET /tools/dynamic + POST /tools；规划已写入 docs/milestones.md。
