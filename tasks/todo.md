...
## M326 开放式 ReAct 稳定交付（已完成）

- [x] M326-A ReAct 增量动作与 workflow 策略解耦
- [x] M326-B/C 部分结果、停止原因、答案与 Evidence 统一投影
- [x] M326-D Artifact 原子发布、Provider JSON 错误边界与 live 验收守卫
- [x] M326-E Docker/GIS、跨入口恢复、文档索引、中文问题日志、版本交付与全局重规划

## M327 开放请求能力发现与结果质量（已完成）

- [x] M327-A 能力描述契约
- [x] M327-B 能力选择与用户可见解释
- [x] M327-C 跨类型结果摘要
- [x] M327-D 跨入口与前端接入
- [x] M327-E Docker 验收、文档收口、版本交付与全局重规划

## M329 通用请求路由与跨域能力汇聚（已完成）

- [x] M329-0 capability map、Spec、Plan、handoff 与热状态
- [x] M329-A request-mode.v1 与 Result/持久化/事件接入
- [x] M329-B 通用 capability host、provider owner dispatch 与降级
- [x] M329-C 通用 Runtime、默认 ReAct 与领域中立答案
- [x] M329-D HTTP、CLI、前端默认通用入口
- [x] M329-E 会话、SQLite、Artifact、SSE 与审批恢复
- [x] M329-F 精简测试、Docker/live 验收、文档、提交推送与全局重规划

## M330 通用 Agent 开放问题质量与纵向行为验收（已完成）

- [x] M330-0 全局 capability map、Spec、Plan、handoff 与恢复快照
- [x] M330-A 非数据普通问题的直接回答与自然语言质量
- [x] M330-B 未预定义问题的能力发现、跨域组合与结构化澄清
- [x] M330-C Web、工具提案、审批恢复和 provider 降级的用户可理解闭环
- [x] M330-D 答案流、事件、结构化结果、证据与前端分层展示一致性
- [x] M330-E Docker/真实模型多场景纵向验收与最小必要回归
- [x] M330-F 文档、索引、版本交付与全局重规划

## M331 真实模型开放任务可靠性与通用能力可用率（规划中）

- [ ] M331-0 全局 capability map、Spec、Plan、handoff 与恢复快照
- [ ] M331-A 真实模型计划/动作协议稳定性与有限修复
- [ ] M331-B 通用任务组合、结果类型推导与证据闭合
- [ ] M331-C 长任务上下文、预算、取消和恢复可用率
- [ ] M331-D 用户答案质量与实时反馈的统一评估
- [ ] M331-E Docker/真实模型纵向验收与最小充分回归
- [ ] M331-F 文档、索引、版本交付与全局重规划
