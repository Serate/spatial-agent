...
## M330 通用 Agent 开放问题质量与纵向行为验收（规划中）

- [ ] M330-0 全局 capability map、Spec、Plan、handoff 与恢复快照
- [ ] M330-A 非数据普通问题的直接回答与自然语言质量
- [ ] M330-B 未预定义问题的能力发现、跨域组合与结构化澄清
- [ ] M330-C Web、工具提案、审批恢复和 provider 降级的用户可理解闭环
- [ ] M330-D 答案流、事件、结构化结果、证据与前端分层展示一致性
- [ ] M330-E Docker/真实模型多场景纵向验收与最小必要回归
- [ ] M330-F 文档、索引、版本交付与全局重规划
