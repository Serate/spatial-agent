"""Deterministic plan composition for routed spatial capabilities.

The public planner only coordinates this module. Capability selection lives in
capability_routing; this module turns a selected capability into TaskPlan steps.
"""
...
from .capability_routing import CapabilityRouter, contains_any
...
class RuleBasedPlanComposer:
    """Compose a validated-shaped TaskPlan from interpreted request facts."""
