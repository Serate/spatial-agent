...
from .network.web_policy import DEFAULT_WEB_MODE, normalize_web_mode


REACT_MODE_ENV = "SPATIAL_AGENT_REACT_MODE"
WEB_MODE_ENV = "SPATIAL_AGENT_WEB_MODE"
...
WEB_FETCH_TIMEOUT_ENV = "SPATIAL_AGENT_WEB_FETCH_TIMEOUT_SECONDS"
WEB_FETCH_MAX_RESPONSE_BYTES_ENV = "SPATIAL_AGENT_WEB_FETCH_MAX_RESPONSE_BYTES"
WEB_FETCH_MAX_MODEL_CHARS_ENV = "SPATIAL_AGENT_WEB_FETCH_MAX_MODEL_CHARS"
TOOL_PROPOSALS_ENABLED_ENV = "SPATIAL_AGENT_TOOL_PROPOSALS_ENABLED"
TOOL_PROPOSAL_SANDBOX_SOCKET_ENV = "SPATIAL_AGENT_TOOL_PROPOSAL_SANDBOX_SOCKET"
TOOL_PROPOSAL_SANDBOX_TIMEOUT_ENV = "SPATIAL_AGENT_TOOL_PROPOSAL_SANDBOX_TIMEOUT_SECONDS"
...
DEFAULT_TOOL_PROPOSAL_SANDBOX_SOCKET = "/app/outputs/sandbox/worker.sock"
DEFAULT_TOOL_PROPOSAL_SANDBOX_TIMEOUT_SECONDS = 3.0
DEFAULT_WEB_SEARCH_TIMEOUT_SECONDS = 8.0
DEFAULT_WEB_SEARCH_MAX_RESPONSE_BYTES = 2 * 1024 * 1024
DEFAULT_WEB_SEARCH_MAX_SOURCES = 8
DEFAULT_WEB_FETCH_TIMEOUT_SECONDS = 10.0
DEFAULT_WEB_FETCH_MAX_RESPONSE_BYTES = 4 * 1024 * 1024
DEFAULT_WEB_FETCH_MAX_MODEL_CHARS = 24_000
...
def open_agent_defaults() -> dict[str, Any]:
    ...
    return {
        "react_mode": mode,
        "web_mode": normalize_web_mode(os.environ.get(WEB_MODE_ENV)),
        ...
        "web_fetch_timeout_seconds": _bounded_float(
            WEB_FETCH_TIMEOUT_ENV, DEFAULT_WEB_FETCH_TIMEOUT_SECONDS, 1.0, 30.0
        ),
        "web_fetch_max_response_bytes": _bounded_int(
            WEB_FETCH_MAX_RESPONSE_BYTES_ENV,
            DEFAULT_WEB_FETCH_MAX_RESPONSE_BYTES,
            1024,
            20 * 1024 * 1024,
        ),
        "web_fetch_max_model_chars": _bounded_int(
            WEB_FETCH_MAX_MODEL_CHARS_ENV,
            DEFAULT_WEB_FETCH_MAX_MODEL_CHARS,
            512,
            48_000,
        ),
        ...
        "tool_proposal_sandbox_socket": str(
            os.environ.get(TOOL_PROPOSAL_SANDBOX_SOCKET_ENV)
            or DEFAULT_TOOL_PROPOSAL_SANDBOX_SOCKET
        ).strip()[:255],
        "tool_proposal_sandbox_timeout_seconds": _bounded_float(
            TOOL_PROPOSAL_SANDBOX_TIMEOUT_ENV,
            DEFAULT_TOOL_PROPOSAL_SANDBOX_TIMEOUT_SECONDS,
            1.0,
            10.0,
        ),
...
__all__ = [
    ...
    "DEFAULT_TOOL_PROPOSAL_SANDBOX_SOCKET",
    "DEFAULT_TOOL_PROPOSAL_SANDBOX_TIMEOUT_SECONDS",
    "DEFAULT_WEB_SEARCH_MAX_RESPONSE_BYTES",
    "DEFAULT_WEB_SEARCH_MAX_SOURCES",
    "DEFAULT_WEB_SEARCH_TIMEOUT_SECONDS",
    ...
    "TOOL_PROPOSAL_SANDBOX_SOCKET_ENV",
    "TOOL_PROPOSAL_SANDBOX_TIMEOUT_ENV",
