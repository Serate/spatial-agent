...
from .artifact_reference import build_artifact_reference, normalize_artifact_reference
...
def build_artifact_manifest(
    ...
    *,
    ...
    completeness = (
        normalize_result_completeness(result.get("completeness"))
        if isinstance(result.get("completeness"), Mapping)
...
def unavailable_artifact_manifest(reason_code: str) -> Dict[str, Any]:
    return {
        "schema_version": ARTIFACT_MANIFEST_SCHEMA_VERSION,
        "available": False,
        "completeness": normalize_result_completeness(None),
        "kind": "run",
